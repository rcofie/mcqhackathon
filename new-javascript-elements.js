...
function slideInLeft() {
  var greenBox = document.querySelector('.subtitle-left')// make sure that in the CSS you just put the class not the HTML tag beforehand otherwise it won't pick it up
